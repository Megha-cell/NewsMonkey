...
const News =(props)=> {
  ...
  const updateNews = async () => {
    try {
      ...
      const url = `https://news-proxy-ic45d1wxp-meghas-projects-0bec7282.vercel.app/news?country=${props.country}&category=${props.category}&apikey=${props.apiKey}&page=${page}&pageSize=${props.pageSize}`;  
      setLoading(true)  
  ...
  // }
    ...
    // 20 more records in 1.5 secs
      ...
      const url = `https://news-proxy-ic45d1wxp-meghas-projects-0bec7282.vercel.app/news?country=${props.country}&category=${props.category}&apikey=${props.apiKey}&page=${page+1}&pageSize=${props.pageSize}`;    
      setPage(page+1)
      let data = await fetch(url);
      let parsedData = await data.json();
